...
namespace MSharp
{
    ...
    static partial class SchemaExtensions
    {
        ...
        [MethodColor("#afcd14")]
        public static PropertyFilterElement<Domain.AuditEvent> ItemGroup(this ListModule<Domain.AuditEvent>.SearchComponents @this, [CallerFilePath] string file = null, [CallerLineNumber] int line = 0) => @this.module.Search(x => x.ItemGroup, file, line);
        ...
        [MethodColor("#afcd14")]
        public static ViewElement<Domain.AuditEvent> ItemGroup(this ViewModule<Domain.AuditEvent>.FieldComponents @this, [CallerFilePath] string file = null, [CallerLineNumber] int line = 0) => @this.module.Field(x => x.ItemGroup, file, line);
        ...
        [MethodColor("#0ccc68")]
        public static ViewElement<Domain.AuditEvent> ItemGroup(this ListModule<Domain.AuditEvent>.ColumnComponents @this, [CallerFilePath] string file = null, [CallerLineNumber] int line = 0) => @this.module.Column(x => x.ItemGroup, file, line);
        ...
        [MethodColor("#AFCD14")]
        public static StringFormElement ItemGroup(this FormModule<Domain.AuditEvent>.FieldComponents @this, [CallerFilePath] string file = null, [CallerLineNumber] int line = 0) => @this.module.Field(x => x.ItemGroup, file, line);
